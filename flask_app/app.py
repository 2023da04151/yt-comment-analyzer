...
model_info = load_model_information("experiment_info.json")
...
tfidf_uri = f"runs:/{run_id}/tfidf_vectorizer"
vectorizer = mlflow.sklearn.load_model(tfidf_uri)

# Load Logistic Regression model
log_model_uri = f"runs:/{run_id}/Logstic_model"
model = mlflow.sklearn.load_model(log_model_uri)
